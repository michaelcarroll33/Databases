...
--Insert branches
INSERT INTO branch(routingnum,cashbalance,city)
VALUES ('123456789', 89734.21, 'Houston');

INSERT INTO branch(routingnum,cashbalance,city)
VALUES ('987654321', 105432.89, 'New York');

--Insert loans
INSERT INTO loan (loannum, loantype, maturity, interestrate, amount, cssn)
VALUES ('LOAN001', 'business', 60, 0.06, 50000, '111111111');

INSERT INTO loan (loannum, loantype, maturity, interestrate, amount, cssn)
VALUES ('LOAN002', 'auto', 36, 0.05, 20000, '111111111');


INSERT INTO loan (loannum, loantype, maturity, interestrate, amount, cssn)
VALUES ('LOAN003', 'house', 240, 0.04, 300000, '222222222');


INSERT INTO loan (loannum, loantype, maturity, interestrate, amount, cssn)
VALUES ('LOAN004', 'business', 60, 0.06, 50000, '333333333');


INSERT INTO loan (loannum, loantype, maturity, interestrate, amount, cssn)
VALUES ('LOAN005', 'auto', 48, 0.05, 25000, '444444444');


INSERT INTO loan (loannum, loantype, maturity, interestrate, amount, cssn)
VALUES ('LOAN006', 'house', 240, 0.04, 300000, '555555555');


INSERT INTO loan (loannum, loantype, maturity, interestrate, amount, cssn)
VALUES ('LOAN007', 'business', 60, 0.06, 50000, '666666666');


INSERT INTO loan (loannum, loantype, maturity, interestrate, amount, cssn)
VALUES ('LOAN008', 'auto', 48, 0.05, 25000, '777777777');


INSERT INTO loan (loannum, loantype, maturity, interestrate, amount, cssn)
VALUES ('LOAN009', 'house', 240, 0.04, 300000, '888888888');


INSERT INTO loan (loannum, loantype, maturity, interestrate, amount, cssn)
VALUES ('LOAN010', 'business', 60, 0.06, 50000, '999999999');
